...
abstract class BaseDocumentPeer {
	...
	const TYPE_ID = 'document.TYPE_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'TypeId', 'UserId', 'Path', 'CreatedAt', ),
		BasePeer::TYPE_COLNAME => array (DocumentPeer::ID, DocumentPeer::TYPE_ID, DocumentPeer::USER_ID, DocumentPeer::PATH, DocumentPeer::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'type_id', 'user_id', 'path', 'created_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'TypeId' => 1, 'UserId' => 2, 'Path' => 3, 'CreatedAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (DocumentPeer::ID => 0, DocumentPeer::TYPE_ID => 1, DocumentPeer::USER_ID => 2, DocumentPeer::PATH => 3, DocumentPeer::CREATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'type_id' => 1, 'user_id' => 2, 'path' => 3, 'created_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(DocumentPeer::TYPE_ID);

		$criteria->addSelectColumn(DocumentPeer::USER_ID);
	...
	public static function doCountJoinType(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(DocumentPeer::TYPE_ID, TypePeer::ID);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(DocumentPeer::USER_ID, UserPeer::ID);
	...
	public static function doSelectJoinType(Criteria $c, $con = null)
	{
		...
		$c->addJoin(DocumentPeer::TYPE_ID, TypePeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getType(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addDocument($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initDocuments();
	...
	public static function doSelectJoinUser(Criteria $c, $con = null)
	{
		...
		$c->addJoin(DocumentPeer::USER_ID, UserPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				$temp_obj3 = $temp_obj1->getUser(); 				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addDocument($obj1); 					break;
				}
			}
	...
	public static function doCountJoinAllExceptType(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptType(Criteria $c, $con = null)
	{
		$c = clone $c;
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			$c->add(SharedPeer::DOC_ID, $obj->getId());
			...
			$c->add(ValuePeer::DOC_ID, $obj->getId());
